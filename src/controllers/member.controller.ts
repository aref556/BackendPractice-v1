...
export class MemberController {
    ...
    // @Get('data_member') // แสดงข้อมูลผู้ใช้ที่เข้าสู่ระบบ
    // getUserMember(@Req() req: Request) {
    //     const userLogin: IMemberDocument = req.user as any;
    ...
    // @Post('change-key') // เปลี่ยน RSA Key
    // changeSSHkey(@Req() req: Request, @Body(new ValidationPipe()) body: ChangeSSHkeyModel) {
    //     return this.service.onChangeSSHkey(req.user['id'], body);
